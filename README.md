...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-util-http-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-util-http-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-util-http
# for installing globally
pixi global install opentelemetry-util-http
```
...
It is possible to list all of the versions of `opentelemetry-util-http` available on your platform:
...
```
pixi search opentelemetry-util-http --channel conda-forge
```
